...
COPY main.py cloud_storage_oci.py config.ini few_shot_util.py io_processing.py translator.py audio_verifier_util.py logger.py script.sh telemetry_logger.py telemetry_middleware.py /root/
EXPOSE 8000
